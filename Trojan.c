...
//configure here the target details
#define TARGET_IP "<target Ip>"
#define TARGET_PORT <target port>

//configure here the attacker details
#define ATTACKER_IP "<attacker Ip>"
#define ATTACKER_PORT <attacker port>
